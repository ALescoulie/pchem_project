...
Nj = Ni.*boltz_dist(Ei, Ej, T_low);

%% Mini project 2

Nj_lev = Nj ./ rotational_degen(1);

%% General fuctions, Boltzmann dist fraction
...
%% Mini project 1 functions, energy of state J
function [E] =  rotational_energy(J, Be)
    E = J .* (J + 1) .* Be;
end

%% Mini project 2 functions, rotational degeneracy
